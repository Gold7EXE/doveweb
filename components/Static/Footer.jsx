                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Dove</p>
                            </div>
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <a href="https://discord.gg/bxRXFD9SKz" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
                                <a href="https://discordapp.com/oauth2/authorize?client_id=1054615960662843492&scope=bot&permissions=2146958847+application.commands" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Invite Bot
                                </a>
                            </div>
                        </div>
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="https://discord.gg/bxRXFD9SKz">
                                    <a className="text-white/50 hover:text-white hover:underline transform duration-200">
