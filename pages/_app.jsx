...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/bxRXFD9SKz",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discordapp.com/oauth2/authorize?client_id=1054615960662843492&scope=bot&permissions=2146958847+application.commands",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/1054615960662843492/vote",
    },
    {
      link: true,
      name: "Partners",
