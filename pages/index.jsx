...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="/img/dove2.gif" />
      </div>
        <p className="animateHeader text-4xl font-extrabold text-center text-white">
          Dove
        </p>
        <p className="animateHeader text-white text-opacity-50 text-center mt-5">
       How about moderating your own server with Dove? Create your own free world and manage your server, experience this pleasure with the best quality. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discordapp.com/oauth2/authorize?client_id=1054615960662843492&scope=bot&permissions=2146958847+application.commands"}>
              <a
                className={
  ...
  <Link href={"https://top.gg/bot/1054615960662843492/vote"}>
...
Vote Dove</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Dove" }} />
            ...
            <a href="https://discordapp.com/oauth2/authorize?client_id=1054615960662843492&scope=bot&permissions=2146958847+application.commands" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite Dove
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, Dove gives you pleasure to the fullest.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
